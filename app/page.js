...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="flex justify-end md:w-1/3">
            <button aria-label="Open cart">
              <div className="relative flex h-11 w-11 items-center justify-center rounded-md border border-neutral-200 text-black transition-colors dark:border-neutral-700 dark:text-white">
                <div className="h-4 transition-all ease-in-out hover:scale-110" />
              </div>
            </button>
          </div>
        </div>
      ...
      <div className="w-full overflow-auto pb-6 pt-1">
      <Marquee
        speed={60}                // 🔹 speed of scrolling (adjust between 40–100)
        gradient={false}          // 🔹 removes fade edges
        pauseOnHover={true}       
      >
              ...
              <div className="group flex h-full w-full items-center justify-center overflow-hidden rounded-lg border bg-white hover:border-blue-600 dark:bg-black relative border-neutral-200 dark:border-neutral-800">
                ...
                <div className="absolute bottom-0 left-0 flex w-full px-4 pb-4">
                  <div className="flex items-center rounded-full border bg-white/70 p-1 text-xs font-semibold text-black backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white">
                    ...
                    <p className="flex-none rounded-full bg-blue-600 p-2 text-white">
                      {product.price}
                      <span className="ml-1 hidden md:inline">USD</span>
                    </p>
                  </div>
                </div>
              </div>
